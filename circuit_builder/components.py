...
class CircuitComponent:
    ...
    def _draw_led_visual(self, active: bool) -> None:
        ...
        vc.create_oval(34, 18, 86, 70, fill=glow_color, outline=body_color, width=3)
        vc.create_polygon(20, 40, 52, 24, 52, 56, fill=body_color, outline=body_color)
        vc.create_line(86, 40, 104, 40, fill="#374151", width=4)
        vc.create_text(60, 82, text=f"{self.operating_current * 1000:.1f} mA" if active else "LED", font=("Arial", 9, "bold"), fill="#1f2937")
    ...
    def _draw_capacitor_visual(self, active: bool) -> None:
        ...
        vc.create_line(6, 40, 42, 40, fill="#475569", width=3)
        vc.create_line(42, 20, 42, 60, fill=plate_color, width=4)
        vc.create_line(70, 20, 70, 60, fill=plate_color, width=4)
        vc.create_line(70, 40, 104, 40, fill="#475569", width=3)
        vc.create_text(56, 68, text=f"{self.capacitance * 1e6:.0f} μF", font=("Arial", 9, "bold"), fill="#0f172a")
    ...
    def _draw_diode_visual(self, active: bool) -> None:
        ...
        vc.create_line(6, 40, 36, 40, fill="#475569", width=3)
        vc.create_polygon(36, 28, 64, 40, 36, 52, fill=body_color, outline=body_color)
        vc.create_line(64, 24, 64, 56, fill=body_color, width=3)
        vc.create_line(64, 40, 104, 40, fill="#475569", width=3)
        vc.create_text(55, 68, text=f"{self.forward_voltage:.1f} V", font=("Arial", 9, "bold"), fill="#0f172a")
    ...
    def _draw_meter_visual(self, active: bool) -> None:
        ...
        vc.create_rectangle(24, 18, 96, 72, fill=shell_color, outline="#111827", width=2)
        ...
        vc.create_arc(32, 32, 88, 88, start=210, extent=120, style=tk.ARC, outline="#1f2937", width=2)
        vc.create_line(center_x, center_y, end_x, end_y, fill="#1f2937", width=3)
        vc.create_text(center_x, 30, text=label, font=("Arial", 12, "bold"), fill="#1f2937")
    ...
    def _draw_ground_visual(self, active: bool) -> None:
        ...
        vc.create_line(56, 20, 56, 54, fill=color, width=4)
        vc.create_line(44, 54, 68, 54, fill=color, width=4)
        vc.create_line(48, 62, 64, 62, fill=color, width=4)
        vc.create_line(52, 70, 60, 70, fill=color, width=4)
    ...
    def _draw_terminal_indicators(self) -> None:
        ...
        if self.orientation == "horizontal":
            placements = [
                {"x": 2, "rely": 0.5, "anchor": "w"},
                {"relx": 1.0, "x": -terminal_size * 2 - 2, "rely": 0.5, "anchor": "w"},
            ]
        else:
            placements = [
                {"relx": 0.5, "y": 2, "anchor": "n"},
                {"relx": 0.5, "rely": 1.0, "y": -terminal_size * 2 - 2, "anchor": "n"},
            ]
        ...
        for placement in placements:
            ...
            dot.create_oval(0, 0, terminal_size * 2, terminal_size * 2, fill=color, outline=color, tags="terminal")
            dot.place(**placement)
            self.terminal_canvases.append(dot)
